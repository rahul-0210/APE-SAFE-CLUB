  ...
  return (
    <div className={`sidebar-main ${sidebarOpen && "extended leftToggle"}`}>
      ...
      <div className='nav-list'>
        <ul>
          {NAV_LINKS.map((item, i) => {
            if (item) {
              return <NavLinkComponent key={i} linkConfig={item} />;
            }else {
              return null
            }
          })}
      ...
      <div className='footerLinks'>
        <a href='https://t.me/TheGarden_group' target='_blank' rel="noreferrer">
          <img src={Telegram} alt='telegram' />
        </a>
        {/* <a href='https://medium.com/@test' target='_blank'>
          <img src={Other} alt='' />
        </a> */}
        {/* <a href='https://linkedin.com/company/test' target='_blank'>
          <img src={Linkedin} alt='' />
        </a> */}
        <a href='https://twitter.com/TheGardenCoin' target='_blank' rel="noreferrer">
          <img src={Twitter} alt='twitter' />
        </a>
        {/* <a href='https://bitcointalk.org/index.php?topic=test.new#new' target='_blank'>
          <img src={Link} alt='' />
        </a> */}
        <a href='https://discord.com/invite/Z5ZJmDMREv' target='_blank' rel="noreferrer">
          <img src={Discord} alt='discord' />
        </a>
        {/* <a href='https://www.reddit.com/r/test/' target='_blank'>
          <img src={Reddit} alt='' />
        </a> */}
      </div>
    </div>
...
function NavLinkComponent({ linkConfig: { logo, path, isExternal, title, subtext } }) {
  return (
    <>
      {isExternal ? (
        <a target='_blank' href={path} className='nav-link' activeClassName='active-nav-link' rel="noreferrer">
          <div className='link-box'>
            ...
            <div>
              <img src={ExternalLink} className='external-link-icon' alt="external-link" />
            </div>
          </div>
        </a>
      ) : (
